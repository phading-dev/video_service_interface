...
export function newProcessMediaUploadingTaskRequest(
  body: ProcessMediaUploadingTaskRequestBody,
): ClientRequestInterface<ProcessMediaUploadingTaskResponse> {
  return {
    descriptor: PROCESS_MEDIA_UPLOADING_TASK,
    body,
  };
}

export function newListMediaUploadingTasksRequest(
  body: ListMediaUploadingTasksRequestBody,
): ClientRequestInterface<ListMediaUploadingTasksResponse> {
  return {
    descriptor: LIST_MEDIA_UPLOADING_TASKS,
    body,
  };
}
...
export function newProcessGcsUploadFileDeletingTaskRequest(
  body: ProcessGcsUploadFileDeletingTaskRequestBody,
): ClientRequestInterface<ProcessGcsUploadFileDeletingTaskResponse> {
  return {
    descriptor: PROCESS_GCS_UPLOAD_FILE_DELETING_TASK,
    body,
  };
}

export function newListGcsUploadFileDeletingTasksRequest(
  body: ListGcsUploadFileDeletingTasksRequestBody,
): ClientRequestInterface<ListGcsUploadFileDeletingTasksResponse> {
  return {
    descriptor: LIST_GCS_UPLOAD_FILE_DELETING_TASKS,
    body,
  };
}

export function newProcessGcsKeyDeletingTaskRequest(
  body: ProcessGcsKeyDeletingTaskRequestBody,
): ClientRequestInterface<ProcessGcsKeyDeletingTaskResponse> {
  return {
    descriptor: PROCESS_GCS_KEY_DELETING_TASK,
    body,
  };
}

export function newListGcsKeyDeletingTasksRequest(
  body: ListGcsKeyDeletingTasksRequestBody,
): ClientRequestInterface<ListGcsKeyDeletingTasksResponse> {
  return {
    descriptor: LIST_GCS_KEY_DELETING_TASKS,
    body,
  };
}
