...
export abstract class ProcessGcsFileDeletinTaskHandlerInterface implements NodeHandlerInterface {
  public descriptor = PROCESS_GCS_FILE_DELETIN_TASK;
  public abstract handle(
    loggingPrefix: string,
    body: ProcessGcsFileDeletinTaskRequestBody,
  ): Promise<ProcessGcsFileDeletinTaskResponse>;
}

export abstract class ListGcsFileDeletinTasksHandlerInterface implements NodeHandlerInterface {
  public descriptor = LIST_GCS_FILE_DELETIN_TASKS;
  public abstract handle(
    loggingPrefix: string,
    body: ListGcsFileDeletinTasksRequestBody,
  ): Promise<ListGcsFileDeletinTasksResponse>;
}
