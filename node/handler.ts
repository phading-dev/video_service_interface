...
export abstract class ProcessMediaUploadingTaskHandlerInterface implements RemoteCallHandlerInterface {
  public descriptor = PROCESS_MEDIA_UPLOADING_TASK;
  public abstract handle(
    loggingPrefix: string,
...
export abstract class ListMediaUploadingTasksHandlerInterface implements RemoteCallHandlerInterface {
  public descriptor = LIST_MEDIA_UPLOADING_TASKS;
  public abstract handle(
    loggingPrefix: string,
...
export abstract class ProcessGcsUploadFileDeletingTaskHandlerInterface implements RemoteCallHandlerInterface {
  public descriptor = PROCESS_GCS_UPLOAD_FILE_DELETING_TASK;
  public abstract handle(
    loggingPrefix: string,
...
export abstract class ListGcsUploadFileDeletingTasksHandlerInterface implements RemoteCallHandlerInterface {
  public descriptor = LIST_GCS_UPLOAD_FILE_DELETING_TASKS;
  public abstract handle(
    loggingPrefix: string,
...
export abstract class ProcessGcsKeyDeletingTaskHandlerInterface implements RemoteCallHandlerInterface {
  public descriptor = PROCESS_GCS_KEY_DELETING_TASK;
  public abstract handle(
    loggingPrefix: string,
...
export abstract class ListGcsKeyDeletingTasksHandlerInterface implements RemoteCallHandlerInterface {
  public descriptor = LIST_GCS_KEY_DELETING_TASKS;
  public abstract handle(
    loggingPrefix: string,
